...
class Flight {
    ...
    //     );
    // }
    //  friend ostream& operator<<(std::ostream& os, const Flight& flight) {
    //     os << "Flight Id: " << flight.Flight_ID<<endl;
    //     os << "Flight model: " << flight.Model<<endl;
    //     os << "Flight Capicity : "<< flight.Capacity<<endl;
    //     os << "Flight airline: " << flight.Airline<<endl;
    //     os << "Flight destination: " << flight.Destination<<endl;
    //     os << "Flight departure time: " << flight.Departure_Time<<endl;
    //     os << "Flight tikect price : " << flight.Ticket_Price<<endl;
    //  }
